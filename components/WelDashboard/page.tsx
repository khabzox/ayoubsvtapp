  ...
  return (
    ...
    <div className="">
      <h1 className='text-black text-3xl font-bold'>
        Welcome&nbsp;
        <span className="text-black text-3xl md:text-3xl font-extrabold bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.purple.400),theme(colors.purple.300),theme(colors.pink.400),theme(colors.orange.400),theme(colors.pink.300),theme(colors.purple.300),theme(colors.purple.400))] bg-[length:200%_auto] animate-gradient">
